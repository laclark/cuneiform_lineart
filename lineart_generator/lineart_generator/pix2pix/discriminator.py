...
def Discriminator():
    """Build convolutional PatchGAN classifier."""
...
def discriminator_loss(disc_real_output, disc_generated_output):
    """Sum of two sigmoid cross-entropy loss terms:
        * real images and an array of ones,
        * generated images and an array of zeros.
    """
    real_loss = gn.LOSS_OBJECT(tf.ones_like(disc_real_output),
                               disc_real_output)
    generated_loss = gn.LOSS_OBJECT(tf.zeros_like(disc_generated_output),
